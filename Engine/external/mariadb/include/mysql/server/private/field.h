...
public:
  ...
  Copy_func *get_copy_func(const Field *from) const
  {
    return from->cmp_type() == REAL_RESULT ? do_field_string : 
                         ...
                         public Type_handler_hybrid_field_type
{
  ...
  const Type_handler *field_type() const; 
  Compression_method *compression_method_ptr;
public:
  LEX_CSTRING field_name;
  LEX_CSTRING comment;			
...
{
  Qualified_column_ident *m_column_type_ref; 
  Table_ident *m_table_rowtype_ref;          
  bool m_cursor_rowtype_ref;                       
  uint m_cursor_rowtype_offset;                    
  Row_definition_list *m_row_field_definitions;    
public:
  Spvar_definition()
...
#define FIELDFLAG_BINARY		1U	
#define FIELDFLAG_NUMBER		2U
#define FIELDFLAG_ZEROFILL		4U
#define FIELDFLAG_PACK			120U	
#define FIELDFLAG_INTERVAL		256U    
#define FIELDFLAG_BITFIELD		512U	
#define FIELDFLAG_BLOB			1024U	
#define FIELDFLAG_GEOM			2048U   

#define FIELDFLAG_TREAT_BIT_AS_CHAR     4096U   
#define FIELDFLAG_LONG_DECIMAL          8192U
#define FIELDFLAG_NO_DEFAULT		16384U  
#define FIELDFLAG_MAYBE_NULL		32768U	
#define FIELDFLAG_HEX_ESCAPE		0x10000U
#define FIELDFLAG_PACK_SHIFT		3
#define FIELDFLAG_DEC_SHIFT		8
#define FIELDFLAG_MAX_DEC               63U

#define MTYP_TYPENR(type) (type & 127U)	
