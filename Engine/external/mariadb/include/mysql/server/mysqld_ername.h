...
{ "ER_NOT_AGGREGATE_FUNCTION", 4105, "Non-aggregate function contains aggregate specific instructions: (FETCH GROUP NEXT ROW)" },
...
{ "ER_VERS_DB_NOT_SUPPORTED", 4132, "System versioning tables in the %`s database are not suported" },
...
{ "ER_VERS_TEMPORARY", 4137, "TEMPORARY tables do not support system versioning" },
